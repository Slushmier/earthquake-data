...
events within certian areas and the number of fatalities that occurred 
...
bad earthquakes. Manilla is identifid as the most at risk, followed by 
Quito, and Port-au-Prince. Port-au-Prince ranks so high because of how 
devestating the 2010 earthquake was.
...
I decided against using nay of hte measures of economic damage, or loss of
...
aggregration of point events into polygon areas can create results that
...
reflextion of what had happened.
...
respresent a cluster of high seismic activity. This way, even an area with 
...
using some webscraped data. Initially, I tried to acquire the geographic
...
decided to use a webscraping tool in R, the rvest package, to get the data
...
for each location as I don't personnaly have access to a global address 
geocoding service. With the list of unique Embassies and Consoluates, I 
combined that datasit with a Natural Earth dataset for the coordinates of
...
have a more hollistic understanding of quantifying earthquake risk. I find 
...
Mexico; Tblisi, Georgia; Peshawar, Pakistan; Manila, Philipines; and 
Beijing, China. We modelled global earthquake risk based on the historic
...
primary factors. Of the 240 global embassies and consolates we analyzed,
